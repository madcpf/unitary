...
def test_equality():
    ...
    assert Move("a1", "b4", move_type=enums.MoveType.JUMP, move_variant=enums.MoveVariant.BASIC) == Move(
        "a1", "b4", move_type=enums.MoveType.JUMP, move_variant=enums.MoveVariant.BASIC
    )
    assert Move("a1", "b4", move_type=enums.MoveType.JUMP, move_variant=enums.MoveVariant.BASIC) != Move(
        "a1", "b4", move_type=enums.MoveType.SLIDE, move_variant=enums.MoveVariant.CAPTURE
    )
